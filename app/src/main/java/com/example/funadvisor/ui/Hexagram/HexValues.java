...
public class HexValues {
    public static String[] values = {
            "Творчество", "Перечение", "Родня (Единомышленники)", "Бегство",
            "Наступление", "Тяжба", "Беспорочность", "Упадок",
            "Воспитание малым", "Проникновение", "Домашние", "Течение",
            "Внутренняя правда", "Разлив", "Приумножение", "Созерцание",
            "Владение многим", "Жертвенный треножник", "Сияние", "Странствие",
            "Разлад", "Еще не конец", "Стиснутые зубы", "Восход",
            "Воспитание великим", "Исправление", "Убранство", "Сосредоточенность",
            "Убыли", "Недоразвитость", "Питание", "Разорение",
            "Выход", "Переразвитие великого", "Смена", "Взаимодействие",
            "Радость", "Истощение", "Последовательность", "Множество",
            "Необходимость ждать", "Колодец", "Уже конец", "Препятствие",
            "Ограничение", "Повторная опасность", "Начальная трудность", "Сближение",
            "Великая мощь", "Постоянство", "Изобилие", "Переразвитие малого",
            "Невеста", "Разрешение", "Молния", "Вольность",
            "Поражение света", "Расцвет", "Подъём", "Смирение",
            "Посещение", "Войско", "Возвращение", "Исполнение"};
    ...
    public static String[] descriptions = {
            "1. Символ состоит из шести черт ян – Добрый знак. Это мужская гексаграмма, означающая месяц апрель и весенние надежды. " +
                    "Но будьте осмотрительны! вы на вершине горы, и возможности спуститься у вас  нет. " +
                    "Так что будьте бдительны и рассудительны, пока находитесь наверху. " +
                    "Не позднее, чем через шесть месяцев ждите крупных перемен. Время благоприятствует вашим начинаниям. " +
                    "В личной жизни у вас  известная неопределенность, необходимо внести в нее ясность. " +
                    "Если желание ваше разумно и скромно, оно непременно исполнится. Кто-то противостоит вам,  " +
                    "но, если будете решительны и непреклонны, вас  ожидает успех. Испытание вы выдержите.",
            "44. Хорошо, если характерной чертой вашего нынешнего поведения будет сдержанность. Отнеситесь внимательно к переменам " +
                    "в контактах с людьми и попытайтесь оценивать их действия менее критично. Исполнение желаний и надежд проблематично. " +
                    "Будьте экономны. Внутренне подготовьтесь к тому, что скоро последуют неожиданные события, не сулящие вам  ничего благоприятного.",
            "13. Куда бы вы не отправились, попадете в хорошее общество. Можете смело вступать в борьбу, преследуя высокие цели: " +
                    "Вас поддержит человек, на которого вы не рассчитывали. Очень скоро дела ваши пойдут на лад. " +
            ...
            "33. Вы только выиграете, если немного сдержите себя. Напористость в данный момент пользы не принесет. " +
                    "Эта гексаграмма благоприятна для интенсивного отдыха и развлечений, а также для консолидации планов на будущее. " +
                    "Осуществление планов отложите до окончания нынешнего периода неопределенности. Используйте его для медитации.",
            "10. В настоящее время ваше поведение должно быть подчеркнуто вежливым, дружелюбным и сдержанным. Уйдите в себя и как следует обдумайте свое положение. " +
                    "Каким-либо способом выкажите уважение к начальству, сейчас это пойдет вам  на пользу. Произойдет неожиданное событие, " +
                    "которое доставит вам  большую радость. Для флирта время неподходящее. Дамы, общаясь с недостаточно хорошо знакомыми мужчинами, " +
                    "должны быть особенно осторожны. Это – период, когда претензии к жизни следует снизить до минимума.",
            "6. Вы ощущаете дисгармонию. Назревает конфликт. Ведите себя скромно и сдержанно; если вам  бросают перчатку, не поднимайте ее. " +
                    ...
                    "Напротив, примите участие в совместной с кем-либо работе. Пусть все идет своим порядком, тогда и наступит мир и покой, и " +
                    "Вы лишний раз убедитесь в том, что жизненные проблемы не только удручают, но и учат.",
            "25. Господствует единство ясности и простоты, которое принесет вам  пользу, если достойные замыслы вы будете проводить в жизнь достойными средствами. " +
            ...
            "12. Вам  многое неясно, волнуют проблемы общественной жизни. К вам  тянутся люди, недостойные вас. Будьте бдительны и предусмотрительны, " +
                    "не принимайтесь ни за что существенное. Ваше окружение не понимает вас: вы без достаточных на то оснований ссоритесь с одним из друзей. " +
                    "Желания ваши исполнятся процентов на восемьдесят, но и то не сразу. В эти дни следите за своим кошельком. Прислушивайтесь к советам начальства, " +
                    "но решения принимайте по собственному усмотрению. Положение скоро изменится.",
            "9. Везение, успех не слишком характерны для вашего нынешнего положения, следует иметь в виду, что ночь наиболее темна перед самым рассветом. " +
                    "Обстановка вам  не ясна, вы не владеете ею, но это переходное состояние. События, которые изменят его к лучшему, уже на подходе. " +
                    "А пока наберитесь терпения и ждите. Вас  привыкли считать человеком, к которому деньги сами текут в руки. " +
            ...
            "57. Положение ваше запутанно, и в данный момент не так просто в нем разобраться и оценить его. Вы склонны изображать события слишком мрачно. " +
                    "Следуйте по пути, который укажет вам  человек из вашего окружения, и убедитесь, что это наилучший выход. Через 5 месяцев " +
                    "Ваша судьба изменится к лучшему. Что-то препятствует исполнению ваших желаний, устранить помехи вам  поможет женщина. " +
                    "В данный период ни в коем случае не позволяйте уговорить себя на такие действия, которые считаете неуместными и ошибочными.",
            "37. Ваше место там, куда тянет сердце, там же вас  ждет и благополучие. Надежды исполнятся с посторонней помощью. " +
            ...
            "53. Если вы будете продвигаться вперед, тщательно продумывая каждый шаг, успех и удача не изменят вам  и в дальнейшем. " +
                    "Счастье и впредь останется вашим спутником, если, не поддаваясь на уговоры, вы не будете опережать события. " +
                    "У черепахи не меньше шансов прийти к финишу первой, чем у зайца. Вы в начале долгого пути. " +
                    "Желание в конце концов исполнится. Финансовые дела существенно поправятся.",
            "61. Работать не одному, а в сотрудничестве с другими для вас  сейчас наиболее выгодно. Остерегайтесь переоценивать свои умственные способности, " +
                    "чтобы не стать спесивым и невыдержанным. Это может поставить под угрозу осуществление ваших планов. Постарайтесь быть скромнее и сдержаннее. " +
                    "Лишь в этом случае, если желания ваши разумны и честны, они исполнятся. Начальство в ближайшем будущем обратит внимание на ваши способности и возможности, " +
                    "оценит их по достоинству, что, естественно, в значительной мере поможет вашему движению по пути успеха.",
            "59. После долгого периода неудач вновь восходит солнце успеха. Оно принесет вам  все, к чему вы стремитесь. Возможно вас  ожидает длительное путешествие. " +
                    "Не тратьте много денег. Что касается ваших научных, производственных и любовных дел, то они пойдут блистательно. " +
                    "В ближайшее время у вас  появится неожиданный шанс занять лидерствующее положение. Желание ваше уже исполняется и исполнится целиком, " +
                    "если вы по-прежнему будете прилагать для этого настойчивые и целенаправленные усилия.",
            "42. Время благоприятствует выдающимся личностям, но и для прочих оно плодотворно. Осуществится задуманное, будет оплачено сделанное. " +
                    "Вы сможете оказать помощь другим. Некое дело, которое вам  поручит начальство, обернется личной выгодой для вас. " +
                    "Кто-то готовится сделать вам  выгодное предложение. Желание исполнится с помощью вышестоящего лица. В ближайшем будущем – возможность неожиданно, " +
                    "но существенно поправить финансовые дела.",
            "20. Будьте готовы к неприятному сюрпризу. Постарайтесь рассудительно и детально осмыслить положение дел; увидеть их так, как они обстоят в действительности. " +
                    "Возможно, вам  придется сменить место работы и жительства. Сейчас вам  необходимо быть особенно внимательным, " +
                    "не позволяйте важным вещам ускользать за пределы вашего влияния. Тщательно продумывайте все действия и тогда получите помощь оттуда, " +
                    "откуда меньше всего ждете. Желания исполнятся, но не так быстро, как бы вам  хотелось. " +
            ...
            "14. Солнце светит ярко. Это означает, что вы ощущаете себя сейчас особенно свободным; кроме того, вы вполне богаты – как с материальной, " +
                    "так и с духовной точки зрения. Сконцентрируйте волю на исполнении тех своих желаний, осуществление которых необходимо для успеха в делах. " +
            ...
            "47. Одна из четырех наихудших гексаграмм. Это не тот период, когда стоило бы приниматься за что-либо. Затаитесь и ждите. Мысли ваши недостаточно ясны. Некто из вашего окружения, занимающий высокое положение, протянет вам  руку помощи. Прислушайтесь к советам этого человека. Вера в собственные силы у вас  сейчас очень слабая. Но не принимайте события слишком трагично, ведь и этот негативный период пройдет и обстоятельства ваши улучшатся.",
            "17. Время более подходит для упрочения руководящих позиций, нежели для вербовки сторонников. Будьте верны своим принципам даже в том случае, если цели ваши изменятся. Впредь довольствуйтесь пока малыми победами и успехами, они непременно повлекут за собой и более крупные. Плывите по течению, а не против него, и тогда все придет в порядок. Желание ваше исполнится с большой долей вероятности, но будьте готовы к серьезным переменам в жизни.",
            "45. Все, что вы сделаете в этот период, за что приметесь, завершится успешным результатом. Некая невидимая сила упрочит ваши отношения с людьми, поможет завязать новые тесные контакты, которые так или иначе станут для вас  благоприятными. Былые труды и усилия будут оплачены. Вас  преследует женщина, она стремится преградить вам  путь, помешать осуществлению ваших намерений, вмешаться в вашу жизнь. Несмотря на это, желания ваши исполнятся.",
            "5. Ждите и собирайтесь с силами, очень скоро они вам  понадобятся – когда наступит весна, сойдет снег и вновь зацветут цветы. Слишком торопливые действия сейчас могут принести только вред. Потерпите еще немного, месяца два, пока не явится некий человек, который поможет вам  так, как вы и не ждете. Если же вы теперь решительно и энергично займетесь планированием дальнейших действий, то помощь и поддержка придут еще быстрее. Ваше материальное положение внезапно улучшится. Возможно, вы почувствуете влечение к человеку старше вас. Старайтесь не слишком обнаружить свой интерес к нему. Желание ваше исполнится, если вы будете действовать целеустремленно и в достаточной мере осмотрительно.",
            "48. Хорошо, если вы протянете другим руку помощи, даже если у вас  самого дела идут не вполне гладко. Впоследствии вы убедитесь, что такой образ действий очень выгоден. В данный период едва ли можно рассчитывать на признание ваших способностей и достижений начальством, что, конечно, малоприятно. Вы страстно желаете, чтобы обстоятельства изменились, но время сейчас не благоприятствует этому. Скромные ваши желания могут исполнится и теперь, а вот крупные – нет. Как ни странно, нынешнее ваше финансовое положение не так плохо.",
            "63. Если вы поссоритесь с кем-либо, срочно обратитесь к третьему лицу с просьбой выступить посредником между вами. Не поддавайтесь желанию вновь повторить однажды достигнутый успех. Если как следует обдумаете этот совет и последуете ему, наградой вам  будет полное осуществление ваших желаний. В данный момент не бросайте все силы на новое назначение, оно не приведет к успеху. Загаданное конкретное желание исполнится с некоторой задержкой.",
            "39. Одна из самых худших гексаграмм. Чем больше усилий вы прилагаете, тем дальше оказываетесь оттесненными назад. Трудно сказать, почему именно, но в данный момент Фортуну ваша судьба не интересует. Лучше всего погрузиться в учебу или научную деятельность и в них найти успокоение. Вполне возможно, что несколько ваших друзей придут вам  на помощь, окажут поддержку. Следите за своими расходами: в этот недобрый период реальна опасность остаться без средств.",
